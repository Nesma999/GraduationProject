...
class ImageeState extends State<Imagee> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child:
            BlocConsumer<CubitApp, CubitStatesApp>(listener: (context, state) {
  ...
  Widget profileRed(){
    return BlocProvider(
        ...
        child:BlocConsumer<CubitApp,CubitStatesApp>(
          listener: (context,state){
            if(state is GetDataState){
              Navigator.pop(context);//3shan 3yza ll bottom sheet t2fl b3d ma a3ml update
            }
          },
          builder: (context,state){
            return Scaffold(
                ...
                child: Column(
                  children: <Widget>[
                    Stack(
                        ...
                        children: [
                          state is AppGetDatabaseLoadingState
                              ...
                              padding: Padding(
                                padding: EdgeInsetsDirectional.only(top: 215, end: 130),
                                child: Icon(
                                  Icons.circle,
                                  color: Colors.red,
                                  size: 15,
                    ...
                    defaultUserInfo(
                        ...
                        width: 30.0, edit: () {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => EditLoc()));
                    }),
                    SizedBox(
                      child: Divider(
                        color: Colors.grey,
