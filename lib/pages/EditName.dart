...
class EditNamee extends StatefulWidget {
  _EditNameeState createState() => _EditNameeState();
}
class _EditNameeState extends State<EditNamee> {
                        ...
                        FirebaseFirestore.instance
                          ...
                          if (snapshot.data()['donor validity'] == 'yes') {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => profile.verifyGreen()));
                          } else if (snapshot.data()['donor validity'] ==
                              'no') {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => profile.verifyRed()));
                          } else {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
